...
public class VisualizationSEIR {
	...
	// Create Chart
	final XYChart chart = new XYChartBuilder().width(600).height(400).theme(ChartTheme.XChart).title("SEIR Model").xAxisTitle("Time (year)").yAxisTitle("Number of individuals").build();
